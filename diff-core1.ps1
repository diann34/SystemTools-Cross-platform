...
Show-Diff 'Actions/ShutdownAction.cs' 90
Show-Diff 'Actions/SleepAction.cs' 90
Show-Diff 'Actions/LockScreenAction.cs' 70
Show-Diff 'Actions/ImmediateRestartAction.cs' 90
Show-Diff 'Actions/CancelShutdownAction.cs' 80
